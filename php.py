...
# Reserved words   ref:http://www.php.net/manual/en/reserved.keywords.php
reserved = (
...
# Not used by parser...exclude these characters
unparsed = (
    ...
    # Comments
    'COMMENT', 'DOC_COMMENT',)
#ref:http://php.net/manual/en/language.operators.php
...
# Operators code for simple tokens
t_php_PLUS                = r'\+'
t_php_MINUS               = r'-'
t_php_MUL                 = r'\*'
t_php_DIV                 = r'/'
...
#this code involves some action so the definition
...
#implementation of states can be done using stack
def t_php_LBRACKET(t):
    r'\['
    t.lexer.push_state('php') #starts state
    return t

def t_php_RBRACKET(t):
    r'\]'
    t.lexer.pop_state()#back to previous state
    return t
